const Item = ({ image2, selection, selectionDisabled, selectionDisabled1 }) => {
  return (
    <div className="w-[314px] bg-gainsboro-300 shrink-0 flex flex-col items-center justify-start pt-1.5 pb-6 pr-[43px] pl-[26px] box-border gap-[11px] text-left text-xl text-black font-radio-canada">
